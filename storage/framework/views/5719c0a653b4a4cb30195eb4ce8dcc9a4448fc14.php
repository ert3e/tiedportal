...
<div class="editable-image mb-b-10">
    ...
    <?php if( $editable ): ?>
        ...
        <?php app('blade.helpers')->get('embed')->current()->setData($__data)->setContent(<<<'EOT_embedc7e1c1cfeef3f96fa8093e51e5a1962d5b87ffb59f42b'
...
EOT_embedc7e1c1cfeef3f96fa8093e51e5a1962d5b87ffb59f42b
); ?>
