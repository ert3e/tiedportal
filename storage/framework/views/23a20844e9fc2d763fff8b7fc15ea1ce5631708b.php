...
?>
    ...
    <?php if( Permissions::has('tasks', 'create') ): ?>
        ...
        <?php app('blade.helpers')->get('embed')->current()->setData($__data)->setContent(<<<'EOT_embedeafaca4051bc04ebc69310b5f9b2a9075b87e74a1fc92'
...
EOT_embedeafaca4051bc04ebc69310b5f9b2a9075b87e74a1fc92
); ?>
