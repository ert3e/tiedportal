...
?>
    ...
    <?php if( Permissions::has('projects', 'create') ): ?>
        ...
        <?php app('blade.helpers')->get('embed')->current()->setData($__data)->setContent(<<<'EOT_embedc2ed6f013477b916f4dabfd53b0f1c265b87e6cf34d04'
...
EOT_embedc2ed6f013477b916f4dabfd53b0f1c265b87e6cf34d04
); ?>
