...
?>
    ...
    <?php if( Permissions::has('customers', 'edit') ): ?>
        ...
        <?php app('blade.helpers')->get('embed')->current()->setData($__data)->setContent(<<<'EOT_embed7a46b23d850fdd572595ed55439c44dc5b87e747b68ca'
...
EOT_embed7a46b23d850fdd572595ed55439c44dc5b87e747b68ca
); ?>
