    ...
    <div class="wrapper-page">
        <div class=" card-box">
            ...
            <div class="panel-body">
                ...
                <?php echo Form::open(['route' => 'password.reset.post', 'class' => 'form-horizontal m-t-20']); ?>
                ...
                <div class="form-group ">
                    <div class="col-xs-12">
                        <?php echo app("blade.helpers")->password( 'password', ['class' => 'form-control', 'placeholder' => 'New password'],  '<i class="fa fa-lock"></i>'); ?>
                    </div>
                </div>

                <div class="form-group ">
                    <div class="col-xs-12">
                        <?php echo app("blade.helpers")->password( 'password_confirmation', ['class' => 'form-control', 'placeholder' => 'Confirm new password'], '<i class="fa fa-lock"></i>'); ?>
                    </div>
                </div>
