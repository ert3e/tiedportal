...
<?php if( Permissions::has('projects', 'edit') && Permissions::has('tasks', 'create') ): ?>
    ...
    <?php app('blade.helpers')->get('embed')->current()->setData($__data)->setContent(<<<'EOT_embed4dcdde0887f5f045b05b5484156443a95b88008e8ff95'
...
EOT_embed4dcdde0887f5f045b05b5484156443a95b88008e8ff95
); ?>
